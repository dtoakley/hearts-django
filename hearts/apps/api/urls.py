...
from .views import ContentDetail, DocumentContentsView, DocumentDetailView, DocumentListView, UserViewSet
...
urlpatterns += [
    ...
    url(r'^documents/(?P<document_id>[0-9]+)/contents/?$', DocumentContentsView.as_view(),
        name='document_contents_list'),
